...
const $role = require.main.require("./const/role.json");
      ...
      // changes full name to shorthand (ironic amirite)
      args[0] = (Object.keys($role.alias).includes(args[0])) ? $role.alias[args[0]] : args[0]

      let category = args[0];

      // changes full subcategory name to shorthand (once again, haha funni)
      args[1] = (Object.keys($role.alias).includes(args[1])) ? $role.alias[args[1]] : args[1]
      ...
      if (args[0] == "all") {
        ...
        .setColor('#ffffff')
        .addField('Mayhem City Roles', $role.rolelist, true)
        ...
        if (rolecat == "ti") {  // TI list
          for (var i=0;i<$role.ti.length;i++) {roledisplay += $role.ti[i]+"\n";} rolecat="Town Investigative";
          ...
          for (var i=0;i<$role.tp.length;i++) {roledisplay += $role.tp[i]+"\n";} rolecat="Town Protective";
          ...
          for (var i=0;i<$role.tk.length;i++) {roledisplay += $role.tk[i]+"\n";} rolecat="Town Killing";
          ...
          for (var i=0;i<$role.ts.length;i++) {roledisplay += $role.ts[i]+"\n";} rolecat="Town Support";
          ...
          for (var i=0;i<$role.town.length;i++) {roledisplay += $role.town[i]+"\n";} rolecat="Town"; var showcat = true;
        ...
        if (rolecat == "mk") { // MK list
          for (var i=0;i<$role.mk.length;i++) {roledisplay += $role.mk[i]+"\n";} rolecat="Mafia Killing";
          ...
          for (var i=0;i<$role.md.length;i++) {roledisplay += $role.md[i]+"\n";} rolecat="Mafia Deception";
          ...
          for (var i=0;i<$role.ms.length;i++) {roledisplay += $role.ms[i]+"\n";} rolecat="Mafia Support";
          ...
          for (var i=0;i<$role.mafia.length;i++) {roledisplay += $role.mafia[i]+"\n";} rolecat="Mafia"; var showcat = true;
        ...
        if (rolecat == "nk") {
          for (var i=0;i<$role.nk.length;i++) {roledisplay += $role.nk[i]+"\n";} rolecat="Neutral Killing";
          ...
          for (var i=0;i<$role.ne.length;i++) {roledisplay += $role.ne[i]+"\n";} rolecat="Neutral Evil";
          ...
          for (var i=0;i<$role.nb.length;i++) {roledisplay += $role.nb[i]+"\n";} rolecat="Neutral Benign";
          ...
          for (var i=0;i<$role.nc.length;i++) {roledisplay += $role.nc[i]+"\n";} rolecat="Neutral Chaos";
          ...
          for (var i=0;i<$role.neutral.length;i++) {roledisplay += $role.neutral[i]+"\n";} rolecat="Neutral"; var showcat = true;
        ...
        if (rolecat == "ck") {
          for (var i=0;i<$role.ck.length;i++) {roledisplay += $role.ck[i]+"\n";} rolecat="Cult Killing";
          exinfo = "...";

        } else if (rolecat == "cc") {
          for (var i=0;i<$role.cc.length;i++) {roledisplay += $role.cc[i]+"\n";} rolecat="Cult Conversion";
          exinfo = "...";

        } else if (rolecat == "cs") {
          for (var i=0;i<$role.cs.length;i++) {roledisplay += $role.cs[i]+"\n";} rolecat="Cult Support";
          exinfo = "...";

        } else {
          for (var i=0;i<$role.cult.length;i++) {roledisplay += $role.cult[i]+"\n";} rolecat="Cult"; var showcat = true;
          exinfo = "...";
        ...
        if (rolecat == "ut") {
          for (var i=0;i<$role.ut.length;i++) {roledisplay += $role.ut[i]+"\n";} rolecat="Unique Town Roles";
          ...
          for (var i=0;i<$role.um.length;i++) {roledisplay += $role.um[i]+"\n";} rolecat="Unique Mafia Roles";
        ...
        /*} else if (rolecat == "uc") {
          ...
          for (var i=0;i<$role.unique.length;i++) {roledisplay += $role.unique[i]+"\n";} rolecat="All Unique Roles";
          exinfo = "**Unique roles** are roles that can only appear once in the role list. However, Amnesiacs can become a unique non-Town role, and the Mafia's promotion system allows non-unique Mafia members to succeed killing $role.";
        }
        ...
        for (var i=0;i<$role.factional.length;i++) {roledisplay += $role.factional[i]+"\n";} rolecat="Factions";
