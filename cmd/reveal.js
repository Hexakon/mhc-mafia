...
const muted = dataAT.muted;
  ...
  if (message.member.roles.find("name", "Alive") && message.author.id == dataID[dataRL.mayor] && message.channel.parentID === dataCH.pubcat && dataAT.revealed === false && dataAT.night === false) {
